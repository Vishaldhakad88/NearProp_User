...
//       setShowResendLink(false); // Hide resend link until timer expires
...
//       setResendDisabled(true);
//       setResendCountdown(30);
//       setShowResendLink(false); // Hide resend link until timer expires again
...
//         });
//       } else {
//         showError(`OTP verification failed: ${res.data.message}`);
//       }
//     } catch (error) {
//       const errorMessage = error.response
//         ? `${error.response.data.message || error.response.statusText} (Status: ${error.response.status})`
...
//             {/* <div className="welcome-circle welcome-circle1"></div>
//             <div className="welcome-circle welcome-circle2"></div> */}
//           </div>
...
//       {/* CSS fix for country code select height */}
//       <style>
//         {`
//           .country-code-select {
//             height: 40px; /* Match the height of welcome-username input */
//             padding: 0 10px; /* Adjust padding for consistency */
//             border: 1px solid #ccc; /* Match border style */
//             border-radius: 4px 0 0 4px; /* Align with input's border-radius */
...
//           .welcome-username,
//           .welcome-password {
//             height: 40px; /* Ensure consistent height reference */
//           }
//         `}
//       </style>
//     </>
